...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, # cog name
 ...
 'ooo': {'name': TTLocalizer.SuitCustom1,
         'singularname': TTLocalizer.SuitCustom1S,
         'pluralname': TTLocalizer.SuitCustom1P,
         'level': 8,
         'hp': (110, 132, 156, 200, 2652),
         'def':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
         'freq':(50,30,10,5,5,50,30,10,5,5,50,30,10,5,5,60),
         'acc':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
         'attacks':
                (('PowerTie',
 ...
 'mh': {'name': TTLocalizer.SuitMrHollywood,
        ...
        'attacks':
                ...
                ('RazzleDazzle',
                    ...
                    (70,75,85,90,95,95,95,95,95,95,95,95,95,95),
                    (50,50,50,50,50,50,50,50,50,50,50,50,50,50)))},
 'see': {'name': TTLocalizer.SuitCustom2,
         'singularname': TTLocalizer.SuitCustom2S,
         'pluralname': TTLocalizer.SuitCustom2P,
         'level': 13,
         'hp': (110, 132, 156, 200, 2652),
         'def':(35,40,45,50,55,60,70,70,70,70,70,70,70,70),
         'freq':(50,30,10,5,5),
         'acc':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
         'attacks':
                 (('ParadigmShift',
 ...
 'rb': {'name': TTLocalizer.SuitRobberBaron,
        ...
        'level': 7,
        'hp':(2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652),
        'def':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
        'freq':(50,30,10,5,5),
        'acc':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
        'attacks':
                ...
                ('TeeOff',
                    ...
                    (50,50,50,50,50,50,50,50,50,50,50,50,50,50)))},
 'bm': {'name': TTLocalizer.SuitCustom3,
        'singularname': TTLocalizer.SuitCustom3S,
        'pluralname': TTLocalizer.SuitCustom3P,
        'level': 8,
        'hp': (2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652, 2652),
        'def':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
        'freq':(50,30,10,5,5),
 ...
 'bw': {'name': TTLocalizer.SuitBigWig,
        ...
        'attacks':
                ...
                ('ThrowBook',
                    ...
                    (50,50,50,50,50,50,50,50,50,50,50,50,50,50)))},
 'ye': {'name': TTLocalizer.SuitCustom4,
         'singularname': TTLocalizer.SuitCustom4S,
         'pluralname': TTLocalizer.SuitCustom4P,
         'level': 8,
         'hp': (110, 132, 156, 200, 2652),
         'def':(35,40,45,50,55,60,65,70,70,70,70,70,70,70),
         'freq':(50,30,10,5,5),
...
SuitAttacks = {'Audit': ('phone', ATK_TGT_SINGLE),
 ...
 'EvilEye': ('glower' and 'effort' , ATK_TGT_SINGLE),
